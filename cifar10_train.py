...
class Train(object):
    ...
    def train(self):
        ...
        for step in range(FLAGS.train_steps):
            ...
            if step % FLAGS.report_freq == 0:
                ...
                print
                format_str % (datetime.now(), step, train_loss_value, examples_per_sec,
                              sec_per_batch)
                print
                'Train top1 error = ', train_error_value
                print
                'Validation top1 error = %.4f' % validation_error_value
                print
                'Validation loss = ', validation_loss_value
                print
                '----------------------------'
            ...
            if step == FLAGS.decay_step0 or step == FLAGS.decay_step1:
                ...
                print
                'Learning rate decayed to ', FLAGS.init_lr
    ...
    def test(self, test_image_array):
        ...
        print
        '%i test batches in total...' % num_batches
        ...
        print
        'Model restored from ', FLAGS.test_ckpt_path
